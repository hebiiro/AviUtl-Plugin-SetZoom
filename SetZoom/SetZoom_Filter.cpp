...
int track_def[] = { 15, 15, 15, 15, 15, 15 };
int track_min[] = {  0,  0,  0,  0,  0,  0 };
int track_max[] = { 26, 26, 26, 26, 26, 26 };
...
EXTERN_C FILTER_DLL __declspec(dllexport) * __stdcall GetFilterTable(void)
{
	...
	static TCHAR filterName[] = TEXT("ズーム変更");
	static TCHAR filterInformation[] = TEXT("ズーム変更 version 1.0.0 by 蛇色");
